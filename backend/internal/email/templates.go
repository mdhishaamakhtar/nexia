              ...
              <table cellpadding="0" cellspacing="0" width="100%%">
                <tr>
                  <td align="center" style="padding-bottom:20px;">
                    <a href="%s" style="display:inline-block;background:#007aff;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;border-radius:12px;padding:14px 32px;letter-spacing:0.01em;font-family:'Nunito',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">Verify Email Address</a>
                  </td>
                </tr>
              </table>
        ...
        <table width="100%%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#fffbf5;border-radius:24px;border:1px solid rgba(148,163,184,0.28);box-shadow:0 4px 24px rgba(0,0,0,0.06);transform:rotate(-0.5deg);padding:0;">
          ...
          <tr>
            <td style="border-top:1px solid rgba(148,163,184,0.2);padding:24px 40px 0;">
              ...
              <div style="background:rgba(196,181,253,0.12);border:1px solid rgba(196,181,253,0.4);border-radius:12px;padding:14px 16px;margin-bottom:20px;font-family:ui-monospace,'SF Mono','Fira Code',monospace;font-size:13px;color:#1f2937;letter-spacing:0.08em;word-break:break-all;">%s</div>
              <p style="margin:0 0 20px;font-size:13px;color:#6b7280;line-height:1.5;font-family:'Nunito',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
              ...
              <table cellpadding="0" cellspacing="0" width="100%%">
                <tr>
                  <td align="center" style="padding-bottom:20px;">
                    <a href="%s" style="display:inline-block;background:#007aff;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;border-radius:12px;padding:14px 32px;letter-spacing:0.01em;font-family:'Nunito',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">Reset Password</a>
                  </td>
                </tr>
              </table>
              <p style="margin:0 0 24px;font-size:12px;color:#6b7280;line-height:1.5;font-family:'Nunito',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
