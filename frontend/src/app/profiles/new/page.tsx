                ...
                <div className="md:col-span-2">
                  ...
                  <div className="flex gap-2 mb-2 flex-wrap">
                    {tags.map((tag, i) => (
                      <span
                        key={i}
                        className="flex items-center gap-1 px-3 py-1 rounded-full bg-indigo-500/20 text-indigo-300 text-sm border border-indigo-500/30"
                      >
                        #{tag.tag}
                        <button
                          onClick={() => removeItem(i, setTags, tags)}
                  ...
                  <Input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" && addItem(tagInput, setTags, tags, setTagInput)
                    }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 p-4 bg-white/5 rounded-xl border border-white/10">
                  <h3 className="text-lg font-medium mb-4 flex items-center gap-2">
                    <Heart className="w-4 h-4 text-rose-400" /> Song Association
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, associated_song_name: e.target.value })
                      }
                    />
                    <Input
                      placeholder="Artist"
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, associated_song_artist: e.target.value })
                      }
                    />
                  </div>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="space-y-2 mb-3">
                    {topSongs.map((song, i) => (
                      ...
                      >
                        ...
                        <button
                          onClick={() => removeItem(i, setTopSongs, topSongs)}
                  ...
                  <div className="flex gap-2">
                    ...
                    <Input
                      ...
                      className="flex-1"
                    />
                    <Button onClick={addSong} variant="secondary" className="!px-3">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {hangoutPlaces.map((p, i) => (
                      ...
                      >
                        {p.place}{" "}
                        <button onClick={() => removeItem(i, setHangoutPlaces, hangoutPlaces)}>
                          <X className="w-3 h-3" />
                        </button>
                      </span>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {foodRestrictions.map((r, i) => (
                      <span
                        key={i}
                        className="bg-rose-500/10 text-rose-300 border border-rose-500/20 px-3 py-1 rounded-lg text-sm flex items-center gap-2"
                      >
                        {r.restriction}{" "}
                        <button
                          onClick={() => removeItem(i, setFoodRestrictions, foodRestrictions)}
                        >
                          <X className="w-3 h-3" />
                        </button>
                      </span>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {movieGenres.map((g, i) => (
                      ...
                      >
                        {g.genre}{" "}
                        <button onClick={() => removeItem(i, setMovieGenres, movieGenres)}>
                          <X className="w-3 h-3" />
                        </button>
                      </span>
                    ))}
                  ...
                  <Input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" &&
                      addItem(movieGenreInput, setMovieGenres, movieGenres, setMovieGenreInput)
                    }
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {bookGenres.map((g, i) => (
                      ...
                      >
                        {g.genre}{" "}
                        <button onClick={() => removeItem(i, setBookGenres, bookGenres)}>
                          <X className="w-3 h-3" />
                        </button>
                      </span>
                    ))}
                  ...
                  <Input
                    ...
                    onKeyDown={(e) =>
                      e.key === "Enter" &&
                      addItem(bookGenreInput, setBookGenres, bookGenres, setBookGenreInput)
                    }
                    placeholder="Add genre..."
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 mb-3">
                    {quotes.map((q, i) => (
                      ...
                      >
                        ...
                        <button
                          onClick={() => removeItem(i, setQuotes, quotes)}
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onKeyDown={(e) =>
                        e.key === "Enter" && addItem(quoteInput, setQuotes, quotes, setQuoteInput)
                      }
                      placeholder="Add a quote..."
                      className="flex-1"
                    />
                    <Button
                      onClick={() => addItem(quoteInput, setQuotes, quotes, setQuoteInput)}
                      variant="secondary"
                    >
                      <Plus className="w-5 h-5" />
                    </Button>
