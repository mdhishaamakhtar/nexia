            ...
            >
                ...
                >
                    ...
                    <blockquote className="text-xl leading-relaxed text-[var(--color-text-primary)] font-serif relative pl-6">
                        <span className="absolute left-0 top-0 text-6xl text-[var(--color-border-highlight)] font-serif leading-none -mt-4">“</span>
                        {quote}
                        <span className="absolute -bottom-6 right-0 text-6xl text-[var(--color-border-highlight)] font-serif leading-none">”</span>
                    </blockquote>
                </motion.div>
            </div>
        </AnimatePresence>
